...
int main (int argc, char* argv[]){
    ...
    // Load the data and simple verification
       ...
       // If data_output exists, read it into colledted_nodecount and error    
       ...
       // Comparison of collected_nodecount and nodecount
       /*
          Note that collected_nodecount are
          the nodes from data_output, and nodecout
          are the nodes from data_input. They must match.
       */
